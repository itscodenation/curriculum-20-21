...
| [**Mid-Year Unit: Hackathon**](units/midyear) |6 Lessons|<ul><li>Enagage in collabortive brainstorming, use a wireframe to plan a webpage.</li><li>Collaborate with team members on a shared project</li><li>Understand how to export projects to a sharable online porfolio</li><li>Develop skills to properly prepare for a presentation</li><li>Complete the Mid-Survey and review HTML, CSS, and jQuery concepts</li></ul>
