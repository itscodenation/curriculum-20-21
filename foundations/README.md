...
|:--------|:---:|:---------|
| [**0: Routines**](units/unit0) | 3 lessons| <ul> <li> Identify two things they are excited to learn at CodeNation and be able to name their classmates and teachers.</li> <li> Navigate the Popcode coding environment. </li> <li> Navigate Google Classroom, create a Github account to share their work, and complete the intake form. </li> </ul>|
